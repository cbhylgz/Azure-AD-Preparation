...
<h2>Description</h2>
In this tutorial I will show you how Active Directory works through the use of two VMs (Virtual Machines), with one running a Windows server to be used as the DC (Domain Controller), and the other being the 'client' that joins said domain.
<br/>
<br />
